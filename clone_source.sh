...
sed -i -e 's/192.168.1.1/192.168.41.1/g' -e 's/ImmortalWrt/TPLink_WR841Nv7/g' package/base-files/files/bin/config_generate  #修改路由器管理IP地址和主机名
#sed -i '577s/4/8/g' target/linux/ar71xx/image/tiny-tp-link.mk  #修改wr703nv1的编译固件大小
